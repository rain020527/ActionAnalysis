...
from Backend_Cut_VibePklParser import Backend_Cut_VibePklParser
...
def main(args):
    ...
    for i in range(len(pkl_list)):
        ...
        subprocess.call(f"python3 Backend_Cut_VibePklParser.py {pkl_list[i]} {args.camera_cfg} {video_list[i]}", shell=True)
