...
class Backend_Cut_VibePklParser(VibePklParser):
...
def main():
    pklparser = Backend_Cut_VibePklParser(DIRNAME, sys.argv[1], sys.argv[2], sys.argv[3]) # pkl, camera cfg, src videoname
