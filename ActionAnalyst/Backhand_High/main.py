...
from Backhand_High_VibePklParser import Backhand_High_VibePklParser
...
def main(args):
    ...
    for i in range(len(pkl_list)):
        ...
        subprocess.call(f"python3 Backhand_High_VibePklParser.py {pkl_list[i]} {args.camera_cfg} {video_list[i]}", shell=True)
